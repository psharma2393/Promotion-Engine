...
public class TestCalculcateCost {
	...
	public void testCalculation1() {
		int result = testee.calculateItemTotalCost(5,5,1,0);
	...
	public void testCalculation2() {
		int result = testee.calculateItemTotalCost(5,6,5,4);
	...
	public void testCalculation3() {
		int result = testee.calculateItemTotalCost(3,5,1,1);
	...
	public void testCalculation4() {
		int result = testee.calculateItemTotalCost(1,1,1,0);
	...
	public void testCalculation5() {
		int result = testee.calculateItemTotalCost(5,5,3,5);
