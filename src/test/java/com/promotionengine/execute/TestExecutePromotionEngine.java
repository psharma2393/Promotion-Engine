...
public class TestExecutePromotionEngine {
	...
	public void testExecution1() {
		...
		Mockito.when(calc.calculateItemTotalCost(anyInt(), anyInt(), anyInt(), anyInt())).thenReturn(280);
	...
	public void testExecution2() {
		...
		Mockito.when(calc.calculateItemTotalCost(anyInt(), anyInt(), anyInt(), anyInt())).thenReturn(100);
	...
	public void testExecution3() {
		...
		Mockito.when(calc.calculateItemTotalCost(anyInt(), anyInt(), anyInt(), anyInt())).thenReturn(370);
	...
	public void testExecution4() {
		...
		Mockito.when(calc.calculateItemTotalCost(anyInt(), anyInt(), anyInt(), anyInt())).thenReturn(505);
	...
	public void testExecution5() {
		...
		Mockito.when(calc.calculateItemTotalCost(anyInt(), anyInt(), anyInt(), anyInt())).thenReturn(750);
